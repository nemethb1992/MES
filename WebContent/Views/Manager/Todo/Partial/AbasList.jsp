			...
			<div class="col-11  px-0">
				...
				<div class='container-fluid collapse list-item-extended-content'
					...
					<div class='row faliure-row'>
						...
						<div class='col-11 '>
							<textarea readonly class='w-100 pt-3 faliure-text'><%int issuesNo = 0;
					...
					<div class='row'>
						<div class='col-3'>
							<button type="button" onclick='openDataSheetModal(this)' value='<%=task.getWorkSlipId()%>' 
						...
						<%}else if(taskDetails.getStatus() == Status.INTERRUPTED || taskDetails.getStatus() == Status.SUSPENDED){%>
						<!-- 													<div class='col-2 offset-7'> -->
						<!-- 														<button type="button" class="btn btn-warning w-100 my-2" -->
						<%-- 															onclick='ResumeTaskFromManager(this)' value='<%=task.getWorkSlipId()%>'>Folytatás</button> --%>
						<!-- 													</div> -->
						<%} %>
					</div>
				</div>
